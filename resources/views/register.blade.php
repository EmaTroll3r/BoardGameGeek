...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ url('styles/login_register-style.css') }}">
        ...
        <script src="{{ url('scripts/validate_credentials.js') }}" defer></script>
        <script src="{{ url('scripts/live_validate_credentials.js') }}" defer></script>
            ...
            <article>
                <div id="form-container">
                    ...
                    <div id="errorContainer">
                        ...
                        <section class='error'>Username already exists. Please choose a different username</section>
                        @elseif($error == 'email_already_used')
                        <section class='error'>Email already exists. Please use a different email address</section>
                        @elseif($error == 'empty_fields')
                        <section class='error'>Empty fields. Please fill all empty fields</section>
                        @endif
                        
                        <section id="error-emailAlreadyUsed" class='error hidden'>Email already exists. Please use a different email address</section>
                        <section id="error-usernameAlreadyUsed" class='error hidden'>Username already exists. Please choose a different username</section>
                        <section id="error-fillAllFields" class='error hidden'>Please fill in all fields</section>
                        <section id="error-passwordLength" class='error hidden'>Password must be at least 8 characters long</section>
                        <section id="error-passwordTooWeak" class='error hidden'>Password must contain at least one uppercase letter, one lowercase letter, one number, and one special character</section>
                        <section id="error-emailNotValid" class='error hidden'>Please enter a valid email address</section>
                    </div>
                    ...
                    <a href="{{ url('login') }}" id="outer-link">Already have an account? Sign In!</a>
                </div>
            </article> 
        </div>
