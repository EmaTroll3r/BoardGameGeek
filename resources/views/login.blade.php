            ...
            <article>
                <div id="form-container">
                    ...
                    <div id="errorContainer">
                        ...
                        <section class='error'>User not found</section>
                        @elseif($error == 'incorrect_password')
                        <section class='error'>Password is incorrect, try again</section>
                    ...
                    <a href="{{ url('register') }}" id="outer-link">Don't have an account? Register!</a>
                </div>
            </article>
        </div>
